...
public class SerialController : MonoBehaviour
{
    ...
    void OnEnable()
    {
        ...
        thread.Start();
        foundPort = GameObject.FindGameObjectWithTag("HeartB");
    }
    ...
    void Update()
    {
        ...
        else
        {
            ...
            //foundPort.thePort = portName;
            if (!foundPort.GetComponent<HeartBeat>().thePort.Equals(portName)) {
                foundPort.GetComponent<HeartBeat>().thePort = portName;
                this.gameObject.name = portName;
                this.gameObject.tag = "SerialPort";
                Debug.Log(portName);
            }
